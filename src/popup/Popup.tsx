  ...
  return (
    <SurfaceShell title="DevRecall">
      <div className="flex min-h-[180px] flex-col gap-4">
        <div>
          <p className="text-sm font-medium text-foreground">Current page</p>
          <p className="mt-1 truncate text-sm text-foreground/65">Ready to save into your library</p>
        </div>
        ...
        <div>
          <button
            ...
            onClick={handleSave}
            className="w-full rounded-md bg-accent px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-accent/90 disabled:bg-foreground/15 disabled:text-foreground/55 disabled:hover:bg-foreground/15"
          >
            {buttonLabel}
          </button>
          {hasApiKey === false && (
        ...
        {showFailedError ? (
          <p className="text-xs text-red-700 dark:text-red-300">
            Couldn't read this page — reload it and try again.
          </p>
        ) : (
        ...
        <button
          ...
          className="mt-auto w-full rounded-md border border-default bg-surface-raised px-3 py-2 text-sm font-medium text-foreground/80 transition-colors hover:bg-foreground/5"
        >
          Open library
        </button>
      </div>
